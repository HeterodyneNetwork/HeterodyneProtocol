...
const LIVE_AUTHORIZATION_CONSUMERS = [
  "agent-authorship.ts",
  "agent-moderation.ts",
  "assurance-downgrade.ts",
  "assurance-observation.ts",
  "assurance.ts",
  "atproto-did-resolution.ts",
  "canonical-profile-selection-authority.ts",
  "claim-ledger.ts",
  "claims.ts",
  "control-security-evidence.ts",
  "control-signing.ts",
  "core-operational-assurance-authority.ts",
  "core-policy.ts",
  "marmot-archive-retention-authority.ts",
  "profile-negotiation.ts",
  "radicle.ts",
