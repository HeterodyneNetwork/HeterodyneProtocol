...
### Accepted independent conformance CI

- [ADR-045](docs/adr/archive/2026-08-15-045-conformance-harness-independence.md)
  records the accepted independent, read-only conformance gate: Core
  verification is anchored by the
  [Core specification](docs/spec/heterodyne-core.md), the
